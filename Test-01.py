...
# Es reagiert dabei auf jeden Statuswechsel, d.h. sowohl auf eine steigende Flanke,
# alsauch auf eine fallende Flanke des Impulses 
# Initial wird der Signalpegel als "LOW" angenommen.
# Eine steigende Flanke wird dann als ein Wechsel von LOW zu HIGH definiert. 
...
def Signal_INT(pin): 
    ...
    # Signal ist jetzt aktiv (HIGH) war aber vorher auf LOW, d.h. es wurde
    # eine steigende Flanke erkannt !
    ...
    # Signal ist jetzt nicht aktiv (LOW) war aber vorher auf HIGH, d.h. es wurde
    # eine fallende Flanke erkannt !
...
while True:								# Endlos Scheife
    # Gib den Schleifenzähler (counter) und die Impulsdauer aus
